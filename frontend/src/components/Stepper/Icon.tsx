import { SvgIcon, type StepIconProps } from '@mui/material'
import { CustomStepIconRoot } from './stepper.style'
...
export function CustomStepIcon(props: StepIconProps) {
	...
	return (
		<CustomStepIconRoot ownerState={{ active }} className={className}>
			{/* {completed ? <Check className='CustomStepIcon-completedIcon' /> : <div className='CustomStepIcon-circle' />} */}
			{completed ? (
				<SvgIcon className='CustomStepIcon-completedIcon'>
					<svg
						x='0px'
						y='0px'
